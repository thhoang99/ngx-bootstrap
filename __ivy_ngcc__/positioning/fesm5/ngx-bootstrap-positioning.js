...
PositioningService.ngInjectableDef = ɵngcc0.ΔdefineInjectable({ token: PositioningService, factory: function PositioningService_Factory(t) { return new (t || PositioningService)(ɵngcc0.Δinject(RendererFactory2), ɵngcc0.Δinject(PLATFORM_ID)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PositioningService, [{
        type: Injectable
    }], function () { return [{ type: RendererFactory2 }, { type: Number, decorators: [{
                type: Inject,
                args: [PLATFORM_ID]
            }] }]; }, { update$$: [], positionElements: [], position: [], addPositionElement: [], deletePositionElement: [], setOptions: [], options: [] });
