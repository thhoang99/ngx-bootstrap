...
BsModalRef.ngInjectableDef = ɵngcc0.ΔdefineInjectable({ token: BsModalRef, factory: function BsModalRef_Factory(t) { return new (t || BsModalRef)(); }, providedIn: null });
...
ModalOptions.ngInjectableDef = ɵngcc0.ΔdefineInjectable({ token: ModalOptions, factory: function ModalOptions_Factory(t) { return new (t || ModalOptions)(); }, providedIn: null });
...
ModalContainerComponent.ngComponentDef = ɵngcc0.ΔdefineComponent({ type: ModalContainerComponent, selectors: [["modal-container"]], factory: function ModalContainerComponent_Factory(t) { return new (t || ModalContainerComponent)(ɵngcc0.ΔdirectiveInject(ModalOptions), ɵngcc0.ΔdirectiveInject(ElementRef), ɵngcc0.ΔdirectiveInject(Renderer2)); }, hostBindings: function ModalContainerComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ΔallocHostVars(1);
        ɵngcc0.Δlistener("click", function ModalContainerComponent_click_HostBindingHandler($event) { return ctx.onClick($event); });
        ɵngcc0.Δlistener("keydown.esc", function ModalContainerComponent_keydown_esc_HostBindingHandler($event) { return ctx.onEsc($event); }, false, ɵngcc0.ΔresolveWindow);
        ɵngcc0.ΔelementHostAttrs(_c0);
    } if (rf & 2) {
        ɵngcc0.ΔelementAttribute(elIndex, "aria-modal", ɵngcc0.Δbind(true));
    } }, ngContentSelectors: _c3, consts: 3, vars: 0, template: function ModalContainerComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ΔprojectionDef();
        ɵngcc0.ΔelementStart(0, "div", _c1);
        ɵngcc0.ΔelementStyling();
        ɵngcc0.ΔelementStart(1, "div", _c2);
        ɵngcc0.Δprojection(2);
        ɵngcc0.ΔelementEnd();
        ɵngcc0.ΔelementEnd();
    } if (rf & 2) {
        ɵngcc0.ΔelementStylingMap(0, ("modal-dialog" + (ctx.config.class ? (" " + ctx.config.class) : "")));
...
ModalBackdropComponent.ngComponentDef = ɵngcc0.ΔdefineComponent({ type: ModalBackdropComponent, selectors: [["bs-modal-backdrop"]], factory: function ModalBackdropComponent_Factory(t) { return new (t || ModalBackdropComponent)(ɵngcc0.ΔdirectiveInject(ElementRef), ɵngcc0.ΔdirectiveInject(Renderer2)); }, hostBindings: function ModalBackdropComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ΔelementHostAttrs(_c4);
...
ModalDirective.ngDirectiveDef = ɵngcc0.ΔdefineDirective({ type: ModalDirective, selectors: [["", "bsModal", ""]], factory: function ModalDirective_Factory(t) { return new (t || ModalDirective)(ɵngcc0.ΔdirectiveInject(ElementRef), ɵngcc0.ΔdirectiveInject(ViewContainerRef), ɵngcc0.ΔdirectiveInject(Renderer2), ɵngcc0.ΔdirectiveInject(ComponentLoaderFactory)); }, hostBindings: function ModalDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.Δlistener("click", function ModalDirective_click_HostBindingHandler($event) { return ctx.onClick($event); });
        ɵngcc0.Δlistener("keydown.esc", function ModalDirective_keydown_esc_HostBindingHandler($event) { return ctx.onEsc($event); });
...
BsModalService.ngInjectableDef = ɵngcc0.ΔdefineInjectable({ token: BsModalService, factory: function BsModalService_Factory(t) { return new (t || BsModalService)(ɵngcc0.Δinject(RendererFactory2), ɵngcc0.Δinject(ComponentLoaderFactory)); }, providedIn: null });
...
ModalModule.ngModuleDef = ɵngcc0.ΔdefineNgModule({ type: ModalModule });
/*@__PURE__*/ ɵngcc0.ΔsetNgModuleScope(ModalModule, { declarations: [ModalBackdropComponent,
        ModalDirective,
...
ModalModule.ngInjectorDef = ɵngcc0.ΔdefineInjector({ factory: function ModalModule_Factory(t) { return new (t || ModalModule)(); } });
    return ModalModule;
}());
