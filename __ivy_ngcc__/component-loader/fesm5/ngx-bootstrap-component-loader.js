...
ComponentLoaderFactory.ngInjectableDef = ɵngcc0.ΔdefineInjectable({ token: ComponentLoaderFactory, factory: function ComponentLoaderFactory_Factory(t) { return new (t || ComponentLoaderFactory)(ɵngcc0.Δinject(ComponentFactoryResolver), ɵngcc0.Δinject(NgZone), ɵngcc0.Δinject(Injector), ɵngcc0.Δinject(PositioningService), ɵngcc0.Δinject(ApplicationRef)); }, providedIn: null });
