...
export declare class TabDirective implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ΔDirectiveDefWithMeta<TabDirective, "tab, [tab]", never, { 'customClass': "customClass", 'active': "active", 'removable': "removable", 'heading': "heading", 'id': "id", 'disabled': "disabled" }, { 'selectTab': "selectTab", 'deselect': "deselect", 'removed': "removed" }, never>;
}
