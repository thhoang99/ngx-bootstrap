...
export declare class ButtonRadioDirective implements ControlValueAccessor, OnInit {
    ...
    static ngDirectiveDef: ɵngcc0.ΔDirectiveDefWithMeta<ButtonRadioDirective, "[btnRadio]", never, { 'value': "value", 'disabled': "disabled", 'uncheckable': "uncheckable", 'btnRadio': "btnRadio" }, {}, never>;
}
