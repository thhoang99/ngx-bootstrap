...
export declare class ButtonCheckboxDirective implements ControlValueAccessor, OnInit {
    ...
    static ngDirectiveDef: ɵngcc0.ΔDirectiveDefWithMeta<ButtonCheckboxDirective, "[btnCheckbox]", never, { 'btnCheckboxTrue': "btnCheckboxTrue", 'btnCheckboxFalse': "btnCheckboxFalse" }, {}, never>;
}
