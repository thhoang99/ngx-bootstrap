...
export declare class BsDropdownDirective implements OnInit, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ΔDirectiveDefWithMeta<BsDropdownDirective, "[bsDropdown],[dropdown]", ["bs-dropdown"], { 'autoClose': "autoClose", 'insideClick': "insideClick", 'isDisabled': "isDisabled", 'isOpen': "isOpen", 'placement': "placement", 'triggers': "triggers", 'container': "container", 'dropup': "dropup" }, { 'onShown': "onShown", 'onHidden': "onHidden", 'isOpenChange': "isOpenChange" }, never>;
}
