...
export declare class CollapseDirective implements AfterViewChecked {
    ...
    static ngDirectiveDef: ɵngcc0.ΔDirectiveDefWithMeta<CollapseDirective, "[collapse]", ["bs-collapse"], { 'isAnimated': "isAnimated", 'display': "display", 'collapse': "collapse" }, { 'collapsed': "collapsed", 'collapses': "collapses", 'expanded': "expanded", 'expands': "expands" }, never>;
}
