...
export declare class ModalDirective implements OnDestroy, OnInit {
    ...
    static ngDirectiveDef: ɵngcc0.ΔDirectiveDefWithMeta<ModalDirective, "[bsModal]", ["bs-modal"], { 'config': "config" }, { 'onShow': "onShow", 'onShown': "onShown", 'onHide': "onHide", 'onHidden': "onHidden" }, never>;
}
