...
export declare class PagerComponent implements ControlValueAccessor, OnInit {
    ...
    static ngComponentDef: ɵngcc0.ΔComponentDefWithMeta<PagerComponent, "pager", never, { 'itemsPerPage': "itemsPerPage", 'totalItems': "totalItems", 'maxSize': "maxSize", 'rotate': "rotate", 'boundaryLinks': "boundaryLinks", 'directionLinks': "directionLinks", 'pageBtnClass': "pageBtnClass", 'align': "align", 'firstText': "firstText", 'previousText': "previousText", 'nextText': "nextText", 'lastText': "lastText", 'disabled': "disabled" }, { 'numPages': "numPages", 'pageChanged': "pageChanged" }, never>;
}
