...
export declare class AlertComponent implements OnInit {
     ...
     */
    close(): void;
    static ngComponentDef: ɵngcc0.ΔComponentDefWithMeta<AlertComponent /**
 * Closes an alert by removing it from the DOM.
 */, "alert,bs-alert", never, { 'type': "type", 'dismissible': "dismissible", 'isOpen': "isOpen", 'dismissOnTimeout': "dismissOnTimeout" }, { 'onClose': "onClose", 'onClosed': "onClosed" }, never>;
}
